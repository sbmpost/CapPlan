CREATE TABLE docs(
    ...
    DOC_NAME VARCHAR (60) with compression NOT NULL,
    DOC_SIZE INT DEFAULT 0 NOT NULL,
    COMMENT VARCHAR (60) with compression NOT NULL,
    ...
    STATETEXT VARCHAR (255) with compression NOT NULL,
    DOC_DATA VARCHAR (255) with compression DEFAULT NULL,
