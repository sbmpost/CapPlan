  ...
  inherited RowControl: TRowControl
    ...
    object PERSONS: TTabSheet
      ...
      object PersonRows: TDataRows
        ...
        MetaLabels = 'NAAM,POSTCODE,ADRES,PLAATS,TELEFOON,TELEFOON2,ID'
    ...
    object APPS: TTabSheet
      ...
      object AppRows: TDataRows
        ...
        Width = 977
        Height = 419
        Hint = 'Klik nieuw om een nieuwe afspraak te maken'
        ColCount = 15
        DefaultRowHeight = 18
        DefaultDrawing = False
        DoubleBuffered = True
        ...
        MetaLabels = 'CODE,VAN,"TOT EN MET",UREN,BETAALD,PRIJS,ID'
        MetaRowId = 'APP_ID'
    ...
    object DOCS: TTabSheet
      ...
      object DocRows: TDataRows
        ...
        MetaLabels = 'DOCUMENT,NOTITIE,PLANNEN,AFGEKEURD,BYTES,"DATUM GEWIJZIGD"'
    ...
    object SCHEDULES: TTabSheet
      ...
      object ScheduleRows: TDataRows
        ...
        MetaLabels = 'AGENDA,WERKNEMER,WEEKSTART,WEEKSTOP,DAGSTART,DAGSTOP,DAGEENH,ID'
