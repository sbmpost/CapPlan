...
TComModule  RowGridModule;
TComModule &_Module = RowGridModule;
...
BEGIN_OBJECT_MAP(ObjectMap)
  OBJECT_ENTRY(CLSID_RowGridX, TRowGridXImpl)
  OBJECT_ENTRY(CLSID_RowCellX, TRowCellXImpl)
  OBJECT_ENTRY(CLSID_RectX, TRectXImpl)
END_OBJECT_MAP()
